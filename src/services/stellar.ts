/**
 * StellarService — Root level Stellar SDK & Soroban RPC client layer.
 * Wraps @stellar/stellar-sdk dynamically for RPC submission, TransactionBuilder,
...
export class StellarService {
  ...
  /**
   * Submits a signed transaction envelope and polls Soroban RPC for ledger confirmation.
   */
  ...
  /**
   * Builds a native XLM payment transaction using TransactionBuilder & Operation.payment.
   */
