 ...
 *
 * Flow:
 *  1. StellarWalletsKit.init({ modules, network })  — initialize kit
 *  2. StellarWalletsKit.setWallet(id)               — select wallet module
 *  3. StellarWalletsKit.fetchAddress()              — prompt user & return public key address
 *  4. StellarWalletsKit.signTransaction(xdr, opts)  — sign transaction XDR envelope
 *  5. StellarWalletsKit.disconnect()                — disconnect session
 */
